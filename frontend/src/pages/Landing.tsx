      ...
      <section className="container mx-auto px-6 pt-12">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Revolutionizing aviation maintenance with cutting-edge artificial
            intelligence. From defect detection to predictive analytics, our
            comprehensive suite ensures optimal aircraft performance and safety.
          </p>
      ...
      <footer className="border-t border-gray-200 bg-white/80 backdrop-blur-sm mt-20">
        <div className="container mx-auto px-6 py-8">
          <div className="text-center text-gray-600">
            <p>
              &copy; 2024 AircraftAI Management System. Ensuring aviation safety

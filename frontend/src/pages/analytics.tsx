            ...
            <div className="transform hover:scale-105 transition-all duration-300">
              ...
              <BarStatsChart
                data={[
                  {
                    category: "Cases",
                    value: analyticsData.analytics.total_similar_cases_found,
                  },
                ]}
                color="#f97316"
                height={200}
              ...
              <BarStatsChart
                data={[
                  ...
                  },
                  {
                    category: "High %",
                    value:
                      analyticsData.analytics.highest_similarity_percentage,
                  },
                  {
                    category: "Low %",
                    value: analyticsData.analytics.lowest_similarity_percentage,
                  },
                ]}
                color="#6366f1"
                height={280}

...
export const GoogleGeminiEffect = ({
  ...
  const words = [
    ...
    },
    {
      text: "AI",
      className:
        "bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent font-bold",
    },
    {
      text: "SYSTEM",
      className:
  ...
  return (
    <div className={cn("sticky top-80 w-screen", className)}>
      ...
      <div className="text-center">
          ...
          <TextGenerateEffect words="CENTER OF EXCELLENCE FOR AI" />

    </div>
<div className="flex justify-center items-center mt-7">
  <div className="flex justify-center items-center w-[40rem] h-40 relative">
    {/* Gradients */}
    ...
    <div className="absolute inset-0 w-full h-full bg-white [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]"></div>
      ...
      <svg
        ...
        className="-mt-20 sm:-mt-32 md:-mt-40 lg:-mt-60 xl:-mt-80 2xl:-mt-[650px] w-full"
      >
        <motion.path

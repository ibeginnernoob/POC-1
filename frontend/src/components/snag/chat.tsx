      ...
      <div className="bg-blue-100 max-w-2xl px-4 py-5 rounded-2xl">
        {!details ? (
          <p className="text-sm font-medium">
            Hello! I'm your AI Snag Report Analyzer. I can help you find the
            best rectification actions based on past resolutions. Simply
            describe your snag issue, select the relevant details from the
            dropdowns, and I'll analyze it using natural language processing to
            suggest appropriate solutions.
          </p>
        ) : (
          <div className="flex flex-col gap-5">
            <p className="text-sm font-medium">
              <Markdown>{details.rectification.ai_recommendation}</Markdown>
            </p>
            <div>
              {/* <p className="text-sm font-medium">
